...
public class InputControl : MonoBehaviour {
 ...
 //   [HideInInspector]
  ...
  //  [HideInInspector]
    ...
    public Slider sliderSenstivity;
    ...
    public void senstivityChange() {
        SmoothMouseLook.instance.sensitivity = sliderSenstivity.value;
    }
    void Update() {
       // print("hori" + joystick.Horizontal + "Vetical" + joystick.Vertical);
      //  sliderSenstivity.value = SmoothMouseLook.instance.sensitivity;
...
//			moveInput = new Vector2(Input.GetAxis("Joystick Move X"), Input.GetAxis("Joystick Move Y"));
            ...
            moveX = Mathf.Clamp(joystick.Horizontal + moveInput.x, -1.0f, 1.0f);
			moveY = Mathf.Clamp(joystick.Vertical + moveInput.y, -1.0f, 1.0f);
            lookX = joystick.Horizontal + /*AccelerateInput(*/lookInput.x;
            lookY = joystick.Vertical + /*AccelerateInput(*/lookInput.y;
#endif
#if UNITY_EDITOR
    ...
    public void nextWeapon()
    {
        ...
        //sliderZoom.instance.mySlider.value = 0f;
    }
    public void stop_nextWeapon()
    {
        selectNextPress = false;
    }
    public void run()
    {
        sprintHold = true;
